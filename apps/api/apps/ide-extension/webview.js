...
export default function App() {
    ...
    return React.createElement("div", { className: "flex flex-col h-screen bg-background text-foreground font-sans" }, React.createElement("div", { className: "flex border-b border-border" }, ["chat", "diff", "context"].map((value) => React.createElement("button", {
        key: value,
    ...
    }, value))), React.createElement("div", { className: "flex-1 overflow-hidden" }, tab === "chat"
        ...
        : null, tab === "context" ? React.createElement(FileTree, { context }) : null));
}
