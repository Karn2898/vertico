...
export default function App() {
    ...
    return React.createElement("div", { className: "flex flex-col h-screen bg-background text-foreground font-sans" }, React.createElement("div", { className: "flex border-b border-border" }, ["chat", "diff", "context"].map((t) => React.createElement("button", {
        key: t,
        onClick: () => setTab(t),
    ...
    }, t))), React.createElement("div", { className: "flex-1 overflow-hidden" }, tab === "chat"
