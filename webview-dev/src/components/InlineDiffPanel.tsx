        ...
        <div className="ml-auto flex gap-2">
          <button
            ...
            style={{
              ...
              fontSize: "0.7rem",
              fontWeight: 500,
              opacity: acceptedHunks.size === 0 ? 0.5 : 1,
              cursor: acceptedHunks.size === 0 ? "not-allowed" : "pointer",
              transition: "opacity 0.12s, background 0.12s",
            }}
            onMouseEnter={(e) => {
              if (acceptedHunks.size > 0) e.currentTarget.style.background = "#c9a46b";
            }}
            onMouseLeave={(e) => {
              if (acceptedHunks.size > 0) e.currentTarget.style.background = "#b8935a";
            }}
          >
            Apply Selected
          </button>
